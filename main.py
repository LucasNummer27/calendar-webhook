...
async def check_availability(request: Request):
    ...
    for day_offset in range(1, 8):
        ...
        # Get UTC offset for the date (handles DST automatically)
        utc_offset = start.strftime("%z")  # e.g. "-0400" or "-0500"
        offset_formatted = f"{utc_offset[:3]}:{utc_offset[3:]}"  # e.g. "-04:00"
